...
const navigation = [
  ...
  },
  {
    ...
    icon: Building2,
    children: [
      { name: 'Firmen', href: '/contacts/companies' },
      { name: 'Personen', href: '/contacts/persons' },
    ],
  },
  {
    name: 'Katalog',
    icon: Package,
    children: [
      { name: 'Produkte', href: '/catalog/products' },
      { name: 'Dienstleistungen', href: '/catalog/services' },
      { name: 'Kategorien', href: '/catalog/categories' },
    ],
  },
  {
    name: 'Leads',
  ...
  },
  {
    ...
    icon: Settings,
    children: [
      { name: 'Übersicht', href: '/settings' },
      { name: 'KI-Anbieter', href: '/settings/ai-providers' },
      { name: 'KI-Prompts', href: '/settings/ai-prompts' },
