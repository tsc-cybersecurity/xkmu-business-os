...
export const requirementsSeedData: NewDinRequirement[] = [
  ...
  // Anforderung 01: TOP, 3/−3 Punkte (Einzelanforderung)
  {
    ...
    topicArea: 1,
    points: 3,
    officialAnforderungText: 'Die Geschäftsfuehrung muss die Gesamtverantwortung für die Informationssicherheit im Unternehmen tragen.',
    questionText: 'Wer traegt die Gesamtverantwortung fuer IT- und Informationssicherheit in Ihrem Unternehmen?',
    recommendationText: 'Die Geschäftsfuehrung muss die Gesamtverantwortung für die Informationssicherheit im Unternehmen uebernehmen. Das Thema IT- und Informationssicherheit muss als relevantes und immer aktuelles Alltagsthema von der Geschäftsleitung in alle Abteilungen des Unternehmens hineingetragen werden.',
  ...
  // Anforderung 02: 1/0 Punkte (Gruppe: 02-1, 02-2, 02-3 - alle muessen erfuellt sein)
  {
    ...
    topicArea: 1,
    points: 1,
    officialAnforderungText: 'Die Geschäftsfuehrung muss – sofern sie sich nicht alleine um die IT kuemmert – eine verantwortliche Person benennen können.',
    questionText: 'Haben Sie jemanden, der für die IT- und Informationssicherheit zustaendig ist? Wenn ja, wer ist das?',
    recommendationText: 'Ernennen Sie eine für die Informationssicherheit zustaendige Person oder beauftragen Sie formell einen Dienstleister.',
    isStatusQuestion: false,
    dependsOn: null,
  },
  {
    ...
    topicArea: 1,
    points: null,
    officialAnforderungText: 'Die Geschäftsfuehrung muss dafuer sorgen, dass die fuer IT- und Informationssicherheit beauftragte Person für die Wahrnehmung ihrer Aufgaben ueber die notwendigen Kapazitaeten verfuegt.',
    questionText: 'Wieviel Kapazitaeten stehen Ihnen oder der von Ihnen benannten Person für diese Taetigkeit zur Verfuegung?',
    recommendationText: 'Die zustaendige Person muss ueber genug freie Kapazitaeten verfuegen und sich regelmaessig zur IT- und Informationssicherheit weiterbilden können.',
    isStatusQuestion: false,
    dependsOn: null,
  },
  {
    ...
    topicArea: 1,
    points: null,
    officialAnforderungText: 'Die Geschäftsfuehrung muss dafuer Sorge tragen, dass die beauftragte Person ueber relevante Kenntnisse im Bereich der Informationssicherheit verfuegt.',
  ...
  // Anforderung 03: 1/0 Punkte (Einzelanforderung)
  {
    ...
    recommendationText: 'Beschaeftigte muessen jederzeit eine Ansprechperson (Notfallkontakt) erreichen können, um ungewoehnliche Vorkommnisse oder Verluste unverzueglich zu melden.',
    isStatusQuestion: false,
    dependsOn: null,
  },
  ...
  // Anforderung 05: TOP, 3/−3 Punkte (Gruppe: 05-1, 05-2)
  {
    ...
    topicArea: 1,
    points: 3,
    officialAnforderungText: 'Alle Unternehmensangehoerigen muessen mit der IT und dem Netzwerk sicher umgehen und verdaechtige Vorkommnisse identifizieren können. Hierfuer bedarf es Einweisungen, Schulungen und Sensibilisierungsmassnahmen.',
    questionText: 'Wie stellen Sie sicher, dass alle Firmenangehoerigen mit der IT und dem Netzwerk sicher umgehen und verdaechtige Vorkommnisse identifizieren können?',
    recommendationText: 'Sie muessen sicherstellen, dass alle Firmenangehoerigen sicher mit der IT und dem Netzwerk umgehen können. Hierfuer bedarf es Einweisungen, Schulungen und Sensibilisierungsmassnahmen.',
    isStatusQuestion: false,
    dependsOn: null,
  },
  {
    ...
    topicArea: 1,
    points: null,
    officialAnforderungText: 'Externe Personen muessen mit der IT und dem Netzwerk sicher umgehen können.',
    ...
    recommendationText: 'Sie muessen sicherstellen, dass externe Personen sicher mit der IT und dem Netzwerk umgehen können.',
    isStatusQuestion: false,
    dependsOn: null,
  },
  // Anforderung 06: 1/0 Punkte (Gruppe: 06-1, 06-2)
  {
    ...
    recommendationText: 'Die Geschäftsleitung muss interne Regelungen zur Vertraulichkeit im Umgang mit der IT formulieren.',
    isStatusQuestion: false,
    dependsOn: null,
  },
  {
  ...
  },
  {
    ...
    topicArea: 2,
    points: null,
    officialAnforderungText: 'Jeder Beschaeftigte darf nur Zugriff auf Daten, Ordner, Anwendungen und Netzwerkbereiche haben, für die er zustaendig ist.',
  ...
  },
  {
    ...
    recommendationText: 'Sichern Sie Ihre Daten regelmaessig so, dass bei einem Datenverlust die Fortfuehrung des Geschäftsbetriebes sichergestellt ist.',
    isStatusQuestion: false,
    dependsOn: 22,
  },
  ...
  },
  {
    ...
    recommendationText: 'Bestimmen Sie eine verantwortliche Person für die Datensicherung.',
    isStatusQuestion: false,
    dependsOn: null,
  },
  ...
  },
  {
    ...
    questionText: 'Wie überprüfen Sie, ob die externe Datensicherung funktioniert hat und ob die Daten vollstaendig sind?',
  ...
  },
  {
    ...
    questionText: 'Wie oft überprüfen Sie die externe Datensicherung?',
  ...
  },
  {
    ...
    topicArea: 4,
    points: null,
    officialAnforderungText: 'Updates muessen unverzueglich nach ihrer Veröffentlichung installiert werden.',
  ...
  },
  {
    ...
    questionText: 'Nach welchem Muster setzt sich Ihr Passwort für das WLAN zusammen?',
