    ...
    blocks: [
      ...
      },
      {
        ...
        content: {
          ...
          columns: 3,
          items: [
            { badge: 'A1', title: 'KI-Quick-Start & Potenzialanalyse', href: '/ki-beratung/a1', deliverables: [{ label: '3 Deliverables', color: 'purple' as const }] },
            { badge: 'A2', title: 'KI-Implementierung – Automationen & Workflows', href: '/ki-beratung/a2', deliverables: [{ label: '3 Deliverables', color: 'purple' as const }] },
            { badge: 'A3', title: 'KI-Assistenten & Chatbots', href: '/ki-beratung/a3', deliverables: [{ label: '3 Deliverables', color: 'purple' as const }] },
            { badge: 'A4', title: 'Prompting, Templates & Governance', href: '/ki-beratung/a4', deliverables: [{ label: '2 Deliverables', color: 'purple' as const }] },
            { badge: 'A5', title: 'KI-Schulungen & Enablement', href: '/ki-beratung/a5', deliverables: [{ label: '2 Deliverables', color: 'purple' as const }] },
            { badge: 'B1', title: 'IT-Assessment & Stabilitätscheck', href: '/it-beratung/b1', deliverables: [{ label: '2 Deliverables', color: 'blue' as const }] },
            { badge: 'B2', title: 'IT-Architektur & Modernisierung', href: '/it-beratung/b2', deliverables: [{ label: '3 Deliverables', color: 'blue' as const }] },
            { badge: 'B3', title: 'Systemintegration & Prozess-IT', href: '/it-beratung/b3', deliverables: [{ label: '2 Deliverables', color: 'blue' as const }] },
            { badge: 'B4', title: 'Betrieb, Monitoring & Dokumentation', href: '/it-beratung/b4', deliverables: [{ label: '3 Deliverables', color: 'blue' as const }] },
            { badge: 'B5', title: 'IT-Standardisierung & Arbeitsplatz-IT', href: '/it-beratung/b5', deliverables: [{ label: '2 Deliverables', color: 'blue' as const }] },
            { badge: 'C1', title: 'Security Quick Check', href: '/cybersecurity/c1', deliverables: [{ label: '3 Deliverables', color: 'green' as const }] },
            { badge: 'C2', title: 'Hardening & Sicherheitsbaselines', href: '/cybersecurity/c2', deliverables: [{ label: '2 Deliverables', color: 'green' as const }] },
            { badge: 'C3', title: 'Backup, Recovery & Ransomware-Resilienz', href: '/cybersecurity/c3', deliverables: [{ label: '3 Deliverables', color: 'green' as const }] },
            { badge: 'C4', title: 'Incident Response & Playbooks', href: '/cybersecurity/c4', deliverables: [{ label: '2 Deliverables', color: 'green' as const }] },
            { badge: 'C5', title: 'Security Awareness & Phishing-Schutz', href: '/cybersecurity/c5', deliverables: [{ label: '2 Deliverables', color: 'green' as const }] },
            { badge: 'C6', title: 'Datenschutz- & Compliance-Unterstützung', href: '/cybersecurity/c6', deliverables: [{ label: '2 Deliverables', color: 'green' as const }] },
          ],
        },
      },
      {
