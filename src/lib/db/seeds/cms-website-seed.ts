    ...
    blocks: [
      ...
      },
      {
        ...
        content: {
          ...
          columns: 3,
          items: [
            { badge: 'A1', title: 'KI-Quick-Start & Potenzialanalyse', deliverables: [{ label: '3 Deliverables', color: 'purple' as const }] },
            { badge: 'A2', title: 'KI-Implementierung – Automationen & Workflows', deliverables: [{ label: '3 Deliverables', color: 'purple' as const }] },
            { badge: 'A3', title: 'KI-Assistenten & Chatbots', deliverables: [{ label: '3 Deliverables', color: 'purple' as const }] },
            { badge: 'A4', title: 'Prompting, Templates & Governance', deliverables: [{ label: '2 Deliverables', color: 'purple' as const }] },
            { badge: 'A5', title: 'KI-Schulungen & Enablement', deliverables: [{ label: '2 Deliverables', color: 'purple' as const }] },
            { badge: 'B1', title: 'IT-Assessment & Stabilitätscheck', deliverables: [{ label: '2 Deliverables', color: 'blue' as const }] },
            { badge: 'B2', title: 'IT-Architektur & Modernisierung', deliverables: [{ label: '3 Deliverables', color: 'blue' as const }] },
            { badge: 'B3', title: 'Systemintegration & Prozess-IT', deliverables: [{ label: '2 Deliverables', color: 'blue' as const }] },
            { badge: 'B4', title: 'Betrieb, Monitoring & Dokumentation', deliverables: [{ label: '3 Deliverables', color: 'blue' as const }] },
            { badge: 'B5', title: 'IT-Standardisierung & Arbeitsplatz-IT', deliverables: [{ label: '2 Deliverables', color: 'blue' as const }] },
            { badge: 'C1', title: 'Security Quick Check', deliverables: [{ label: '3 Deliverables', color: 'green' as const }] },
            { badge: 'C2', title: 'Hardening & Sicherheitsbaselines', deliverables: [{ label: '2 Deliverables', color: 'green' as const }] },
            { badge: 'C3', title: 'Backup, Recovery & Ransomware-Resilienz', deliverables: [{ label: '3 Deliverables', color: 'green' as const }] },
            { badge: 'C4', title: 'Incident Response & Playbooks', deliverables: [{ label: '2 Deliverables', color: 'green' as const }] },
            { badge: 'C5', title: 'Security Awareness & Phishing-Schutz', deliverables: [{ label: '2 Deliverables', color: 'green' as const }] },
            { badge: 'C6', title: 'Datenschutz- & Compliance-Unterstützung', deliverables: [{ label: '2 Deliverables', color: 'green' as const }] },
          ],
        },
      },
      {
...
async function seed() {
  ...
  for (const pageData of pages) {
    ...
    await db
      .update(cmsPages)
      .set({
        publishedBlocks: JSON.stringify(allBlocks),
