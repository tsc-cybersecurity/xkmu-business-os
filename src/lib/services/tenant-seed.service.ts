...
import { DEFAULT_TEMPLATES } from '@/lib/services/ai-prompt-template.service'

// ============================================
// AI Prompt Templates (Slugs aus DEFAULT_TEMPLATES)
// ============================================
...
const BLOCK_TEMPLATES = [
  ...
  { name: 'FAQ Allgemein', blockType: 'faq', content: { sectionTitle: 'Haeufig gestellte Fragen', items: [{ question: 'Wie kann ich den Service nutzen?', answer: 'Registrieren Sie sich kostenlos und starten Sie sofort.' }, { question: 'Welche Zahlungsmethoden werden akzeptiert?', answer: 'Wir akzeptieren Ueberweisung, Kreditkarte und SEPA-Lastschrift.' }, { question: 'Gibt es eine kostenlose Testphase?', answer: 'Ja, alle Pakete koennen 14 Tage kostenfrei getestet werden.' }, { question: 'Wie erreiche ich den Support?', answer: 'Per E-Mail, Telefon oder ueber das Kontaktformular auf unserer Website.' }] }, settings: {}, isSystem: true },
  ...
  { name: 'Kennzahlen Unternehmen', blockType: 'stats', content: { sectionTitle: 'Unser Unternehmen in Zahlen', columns: 4, variant: 'cards', items: [{ value: '15+', label: 'Jahre Erfahrung' }, { value: '500+', label: 'Zufriedene Kunden' }, { value: '99.9%', label: 'Verfuegbarkeit' }, { value: '50+', label: 'Mitarbeiter' }] }, settings: {}, isSystem: true },
  { name: 'Team 3 Personen', blockType: 'team', content: { sectionTitle: 'Unser Team', columns: 3, items: [{ name: 'Max Mustermann', role: 'Geschaeftsfuehrer', bio: 'Ueber 20 Jahre Erfahrung in der IT-Branche.' }, { name: 'Erika Musterfrau', role: 'Technische Leitung', bio: 'Expertin fuer Cloud-Architekturen und DevOps.' }, { name: 'Thomas Beispiel', role: 'Vertriebsleitung', bio: 'Spezialist fuer Kundenbeziehungen im Mittelstand.' }] }, settings: {}, isSystem: true },
  ...
  { name: 'CTA Download Whitepaper', blockType: 'cta', content: { headline: 'Kostenloses Whitepaper', description: 'Erfahren Sie in unserem Leitfaden, wie Sie Ihre IT-Sicherheit in 10 Schritten verbessern koennen.', buttons: [{ label: 'Jetzt herunterladen', href: '#download', variant: 'default' }], highlights: [{ icon: 'FileText', title: '24 Seiten', subtitle: 'Praxis-Leitfaden' }, { icon: 'Shield', title: 'IT-Sicherheit', subtitle: 'Aktuell 2025' }] }, settings: {}, isSystem: true },
  { name: 'Ueber uns Text', blockType: 'text', content: { content: '## Ueber unser Unternehmen\n\nSeit ueber 15 Jahren sind wir Ihr zuverlaessiger Partner fuer IT-Dienstleistungen im Mittelstand. Mit einem Team aus erfahrenen Spezialisten betreuen wir Unternehmen in der gesamten DACH-Region.\n\n### Unsere Mission\n\nWir machen Technologie einfach. Unsere Kunden sollen sich auf ihr Kerngeschaeft konzentrieren koennen, waehrend wir uns um die IT kuemmern.\n\n### Unsere Werte\n\n- **Zuverlaessigkeit** - Wir halten, was wir versprechen\n- **Transparenz** - Klare Kommunikation und faire Preise\n- **Innovation** - Immer am Puls der Technik\n- **Partnerschaft** - Langfristige Zusammenarbeit auf Augenhoehe', alignment: 'left' }, settings: {}, isSystem: true },
  { name: 'Impressum Text', blockType: 'text', content: { content: '## Impressum\n\n**Muster GmbH**\nMusterstrasse 1\n12345 Musterstadt\n\nTelefon: +49 123 456 789\nE-Mail: info@muster-gmbh.de\n\n**Geschaeftsfuehrer:** Max Mustermann\n\n**Registergericht:** Amtsgericht Musterstadt\n**Registernummer:** HRB 12345\n\n**USt-IdNr.:** DE123456789\n\n### Haftungsausschluss\n\nDie Inhalte dieser Website werden mit groesster Sorgfalt erstellt. Fuer die Richtigkeit, Vollstaendigkeit und Aktualitaet der Inhalte koennen wir jedoch keine Gewaehr uebernehmen.', alignment: 'left' }, settings: {}, isSystem: true },
  { name: 'Seitenheader Leistungen', blockType: 'heading', content: { text: 'Unsere Leistungen', level: 'h1', subtitle: 'Professionelle IT-Services fuer Ihren Geschaeftserfolg', alignment: 'center' }, settings: {}, isSystem: true },
  ...
  { name: 'FAQ IT-Dienstleistungen', blockType: 'faq', content: { sectionTitle: 'Haeufige Fragen zu unseren IT-Services', items: [{ question: 'Was ist Managed IT?', answer: 'Bei Managed IT uebernehmen wir die komplette Betreuung Ihrer IT-Infrastruktur. Das umfasst Monitoring, Wartung, Updates und Support zu einem festen monatlichen Preis.' }, { question: 'Wie schnell koennen Sie bei Problemen helfen?', answer: 'Unsere garantierte Reaktionszeit betraegt je nach SLA zwischen 1 und 4 Stunden. Kritische Stoerungen werden priorisiert behandelt.' }, { question: 'Bieten Sie auch Cloud-Loesungen an?', answer: 'Ja, wir sind zertifizierter Partner von Microsoft Azure, AWS und Google Cloud. Wir beraten Sie herstellerneutral und finden die optimale Loesung.' }, { question: 'Was kostet eine IT-Betreuung?', answer: 'Die Kosten richten sich nach der Anzahl der Arbeitsplaetze und dem gewuenschten Service-Level. Ab ca. 50 EUR pro Arbeitsplatz/Monat erhalten Sie eine Rundum-Betreuung.' }, { question: 'Koennen Sie auch vor Ort kommen?', answer: 'Selbstverstaendlich. Wir loesen zwar 90% aller Probleme remote, aber fuer Installationen und komplexe Themen kommen wir gerne zu Ihnen.' }] }, settings: {}, isSystem: true },
  { name: 'FAQ Bestellprozess', blockType: 'faq', content: { sectionTitle: 'Fragen zum Bestellprozess', items: [{ question: 'Wie bestelle ich?', answer: 'Sie koennen direkt ueber unseren Online-Shop bestellen oder uns per E-Mail/Telefon kontaktieren. Wir erstellen Ihnen gerne ein individuelles Angebot.' }, { question: 'Welche Zahlungsarten gibt es?', answer: 'Wir akzeptieren Ueberweisung, Kreditkarte (Visa, Mastercard), SEPA-Lastschrift und PayPal. Fuer Geschaeftskunden bieten wir Zahlung auf Rechnung.' }, { question: 'Wie lang sind die Lieferzeiten?', answer: 'Standardprodukte liefern wir innerhalb von 2-5 Werktagen. Fuer individuelle Loesungen erstellen wir einen Projektplan mit konkreten Meilensteinen.' }, { question: 'Kann ich meine Bestellung stornieren?', answer: 'Standardbestellungen koennen innerhalb von 14 Tagen storniert werden. Bei individuellen Projekten gelten die vertraglich vereinbarten Konditionen.' }] }, settings: {}, isSystem: true },
  ...
  { name: 'Team Geschaeftsfuehrung', blockType: 'team', content: { sectionTitle: 'Geschaeftsfuehrung', sectionSubtitle: 'Die Koepfe hinter dem Unternehmen', columns: 2, items: [{ name: 'Dr. Michael Schulz', role: 'Geschaeftsfuehrer / CEO', bio: 'Dr. Schulz gruendete das Unternehmen 2010 nach 15 Jahren Erfahrung in der IT-Beratung. Er verantwortet die strategische Ausrichtung und Kundenbeziehungen.' }, { name: 'Sarah Keller', role: 'Technische Geschaeftsfuehrerin / CTO', bio: 'Sarah Keller bringt ueber 12 Jahre Erfahrung in Cloud-Architekturen und Softwareentwicklung mit. Sie leitet das technische Team und die Produktentwicklung.' }] }, settings: {}, isSystem: true },
  ...
  { name: 'Onboarding Prozess', blockType: 'timeline', content: { sectionTitle: 'So starten wir zusammen', sectionSubtitle: 'In 4 Schritten zum Erfolg', items: [{ icon: 'Phone', title: 'Erstgespraech', description: 'Wir lernen Ihre Anforderungen kennen und besprechen moegliche Loesungen.' }, { icon: 'Search', title: 'Analyse', description: 'Wir analysieren Ihre bestehende Infrastruktur und erstellen ein Konzept.' }, { icon: 'Settings', title: 'Einrichtung', description: 'Wir setzen die vereinbarten Loesungen um und schulen Ihre Mitarbeiter.' }, { icon: 'CheckCircle', title: 'Betrieb', description: 'Laufende Betreuung, Monitoring und kontinuierliche Optimierung.' }] }, settings: {}, isSystem: true },
  { name: 'Firmengeschichte', blockType: 'timeline', content: { sectionTitle: 'Unsere Geschichte', sectionSubtitle: 'Meilensteine unserer Entwicklung', items: [{ icon: 'Star', title: '2010 - Gruendung', description: 'Start als IT-Beratung mit 3 Mitarbeitern in Muenchen.' }, { icon: 'Users', title: '2014 - Wachstum', description: 'Erweiterung auf 15 Mitarbeiter und Eroeffnung des zweiten Standorts.' }, { icon: 'Shield', title: '2018 - Security', description: 'Aufbau des Cybersecurity-Geschaeftsbereichs und ISO 27001 Zertifizierung.' }, { icon: 'Cloud', title: '2021 - Cloud', description: 'Start der Cloud-Services und Partnerschaft mit Microsoft und AWS.' }, { icon: 'TrendingUp', title: '2025 - Heute', description: 'Ueber 45 Mitarbeiter, 3 Standorte und mehr als 350 betreute Kunden.' }] }, settings: {}, isSystem: true },
...
export class TenantSeedService {
  ...
  private static async seedCmsBlockTypeDefinitions(): Promise<number> {
  ...
  private static async seedDinData(): Promise<void> {
    ...
    for (const pageData of CMS_PAGES) {
      ...
      for (const blockData of pageData.blocks) {
        await db.insert(cmsBlocks).values({
          ...
          settings: (blockData as Record<string, unknown>).settings || {},
          isVisible: true,
        })
      }
      created++
