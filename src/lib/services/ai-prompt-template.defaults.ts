    ...
    outputFormat: `Antworte NUR mit folgendem JSON:
{
  ...
  blog_to_x: {
    ...
    description: 'Wandelt einen Blogbeitrag in einen X/Twitter-Post-Entwurf um (max. 280 Zeichen inkl. Link + Hashtags).',
...
- Im "content"-Feld KEINE Markdown-Formatierung:
  ...
  Reiner Text + Zeilenumbrueche (\\n) + Url + ggf. ein Emoji.`,
    userPrompt: `Wandle den folgenden Blogbeitrag in einen X-Post-Entwurf um.

HARTES LIMIT: gesamter Tweet (content + URL + Hashtags mit je 1 Leerzeichen davor) maximal 280 Zeichen. Ziel 240-260.
...
{{#if url}}URL (zaehlt als Klartext mit, in content einbauen, NICHT als Markdown-Link): {{url}}{{/if}}

Erstelle einen praegnanten Tweet (inkl. URL im content-Feld) + 2-3 kurze Hashtags.`,
    outputFormat: `Antworte NUR mit folgendem JSON:
{
