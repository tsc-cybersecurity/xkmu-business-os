...
export const SocialMediaAIService = {
  async generatePost(
    ...
    const template = await AiPromptTemplateService.getOrDefault(context.tenantId, 'social_media_post')
  ...
  async generateContentPlan(
    ...
    const template = await AiPromptTemplateService.getOrDefault(context.tenantId, 'social_media_content_plan')
  ...
  async improvePost(
    ...
    const template = await AiPromptTemplateService.getOrDefault(context.tenantId, 'social_media_improve')
