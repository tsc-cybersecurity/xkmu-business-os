...
const BLOCK_TYPE_DEFAULTS: Array<Omit<NewCmsBlockTypeDefinition, 'id' | 'createdAt'>> = [
  ...
  },
  {
    ...
    defaultContent: { sectionTitle: 'Haeufige Fragen', items: [{ question: 'Wie kann ich starten?', answer: 'Registrieren Sie sich einfach und legen Sie los.' }, { question: 'Gibt es eine Testphase?', answer: 'Ja, Sie können unseren Service 14 Tage kostenlos testen.' }] },
    defaultSettings: {},
    isActive: true,
    sortOrder: 9,
  },
  ...
  },
  {
    ...
    category: 'content',
    fields: ['sectionTitle', 'columns', 'items'],
    defaultContent: { sectionTitle: 'Unser Team', columns: 3, items: [{ name: 'Anna Schmidt', role: 'Geschäftsfuehrung', bio: 'Ueber 15 Jahre Erfahrung.' }, { name: 'Tom Mueller', role: 'Technik', bio: 'Full-Stack Entwickler.' }] },
    defaultSettings: {},
    isActive: true,
    sortOrder: 11,
  },
  ...
  },
  {
    ...
    defaultContent: { text: 'Wichtige Ankuendigung: Neues Update verfügbar!', variant: 'brand', icon: 'Megaphone', buttonLabel: 'Mehr erfahren', buttonHref: '#' },
    defaultSettings: {},
    isActive: true,
    sortOrder: 16,
  },
  ...
  },
  {
    slug: 'service-cards',
    name: 'Service-Karten',
    description: 'Service-Karten mit Badge, Checkliste und Deliverable-Tags',
    icon: 'ClipboardCheck',
    category: 'content',
    fields: ['sectionTitle', 'sectionSubtitle', 'columns', 'items'],
    defaultContent: {
      ...
      items: [{
        badge: 'B1',
        title: 'Service-Titel',
        description: 'Kurze Beschreibung des Service.',
        checklistItems: ['Leistungspunkt 1', 'Leistungspunkt 2', 'Leistungspunkt 3'],
        deliverables: ['Ergebnis 1', 'Ergebnis 2'],
      }],
    },
    defaultSettings: {},
    isActive: true,
