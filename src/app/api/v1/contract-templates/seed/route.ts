...
const SYSTEM_CLAUSES = [
  // --- general ---
  { category: 'general', name: 'Praeambel', sortOrder: 1, bodyHtml: '<p>Die nachfolgenden Vertragsparteien schliessen diesen Vertrag in gegenseitigem Einverstaendnis und im Bewusstsein der sich daraus ergebenden Rechte und Pflichten. Dieser Vertrag regelt die Zusammenarbeit der Parteien und bildet die Grundlage fuer alle hieraus resultierenden Leistungsbeziehungen.</p>', isSystem: true, tenantId: null },
  { category: 'general', name: 'Vertragsgegenstand', sortOrder: 2, bodyHtml: '<p>Gegenstand dieses Vertrages ist die Erbringung der in der Leistungsbeschreibung (Anlage 1) naeher definierten Leistungen durch den Auftragnehmer. Art, Umfang und Qualitaet der Leistungen ergeben sich aus den vertraglichen Vereinbarungen einschliesslich aller Anlagen.</p>', isSystem: true, tenantId: null },
  { category: 'general', name: 'Definitionen', sortOrder: 3, bodyHtml: '<p>Im Sinne dieses Vertrages gelten folgende Definitionen: &bdquo;Vertrauliche Informationen&ldquo; sind alle nicht oeffentlich zugaenglichen Geschaefts- und Betriebsgeheimnisse. &bdquo;Personenbezogene Daten&ldquo; sind Daten im Sinne von Art. 4 Nr. 1 DSGVO. &bdquo;Werktage&ldquo; sind Montag bis Freitag, ausgenommen gesetzliche Feiertage am Erfuellungsort.</p>', isSystem: true, tenantId: null },
