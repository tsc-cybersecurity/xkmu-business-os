  ...
  return (
    <Tabs defaultValue="auth" className="space-y-6">
      <TabsList className="flex flex-wrap h-auto gap-1 bg-transparent p-0">
        ...
        <TabsTrigger value="activities" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">Aktivitäten</TabsTrigger>
  ...
  -F "mode=merge"`}
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <EndpointDoc
              ...
              description="Demo-Daten für den Tenant importieren (CMS-Seiten, Blog, Firmen, Personen, Leads, Produkte, Aktivitäten)"
              responseExample={{
      ...
      <TabsContent value="ideas" className="space-y-4">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Geschäftsideen erfassen und in Leads konvertieren</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
      ...
      <TabsContent value="activities" className="space-y-4">
        <Card>
          ...
          <CardContent className="space-y-6">
            <EndpointDoc method="GET" path="/api/v1/activities" description="Aktivitäten auflisten" queryParams={['page=1', 'limit=20', 'companyId=uuid', 'personId=uuid', 'leadId=uuid', 'type=call|email|meeting|note']} responseExample={{ data: [{ id: 'uuid', type: 'call', subject: 'Erstgespräch', notes: 'Interesse an Produkt X', companyId: 'uuid', createdAt: '2026-02-24T10:00:00Z' }], pagination: { page: 1, limit: 20, total: 50 } }} />
            <EndpointDoc method="POST" path="/api/v1/activities" description="Neue Aktivität anlegen" requestBody={{ type: 'call', subject: 'Nachfass-Anruf', notes: 'Angebot besprochen', companyId: 'uuid', personId: 'uuid' }} responseExample={{ id: 'uuid', type: 'call' }} />
            <EndpointDoc method="GET" path="/api/v1/activities/:id" description="Einzelne Aktivität abrufen" responseExample={{ id: 'uuid', type: 'call', subject: 'Erstgespräch', notes: '...' }} />
      ...
      <TabsContent value="cms" className="space-y-4">
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <EndpointDoc method="DELETE" path="/api/v1/cms/navigation/:id" description="Navigationseintrag löschen" responseExample={{ message: 'Eintrag gelöscht' }} />
      ...
      <TabsContent value="social" className="space-y-4">
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <EndpointDoc method="DELETE" path="/api/v1/social-media/posts/:id" description="Post löschen" responseExample={{ message: 'Post gelöscht' }} />
            ...
            <EndpointDoc method="DELETE" path="/api/v1/social-media/topics/:id" description="Thema löschen" responseExample={{ message: 'Thema gelöscht' }} />
          </CardContent>
        </Card>
      </TabsContent>
      ...
      <TabsContent value="din" className="space-y-4">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Digitalisierungs-Checks fuer KMU und Fördermittel</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <EndpointDoc method="DELETE" path="/api/v1/din/audits/:id" description="Audit löschen" responseExample={{ message: 'Audit gelöscht' }} />
            ...
            <EndpointDoc method="DELETE" path="/api/v1/din/grants/:id" description="Foerderprogramm löschen" responseExample={{ message: 'Foerderprogramm gelöscht' }} />
          </CardContent>
        </Card>
      </TabsContent>
      ...
      <TabsContent value="media" className="space-y-4">
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <EndpointDoc method="DELETE" path="/api/v1/media/:id" description="Datei löschen (DB-Eintrag + Datei auf Disk)" responseExample={{ message: 'Datei gelöscht' }} />
            <EndpointDoc method="GET" path="/api/v1/media/serve/:tenantId/:filename" description="Hochgeladene Datei ausliefern (öffentlich, kein Auth). Cache: 1 Jahr, immutable." responseExample={{ '(Bilddatei als Binary-Response)': true }} />
          </CardContent>
        </Card>
      </TabsContent>
      ...
      <TabsContent value="public" className="space-y-4">
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <EndpointDoc method="GET" path="/api/v1/public/blog/posts" description="Veröffentlichte Blog-Beitraege (öffentlich, keine Auth)" queryParams={['page=1', 'limit=10']} responseExample={{ data: [{ title: 'IT-Trends', slug: 'it-trends', excerpt: '...', publishedAt: '2026-02-20' }] }} />
      ...
      <TabsContent value="n8n" className="space-y-4">
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <EndpointDoc method="DELETE" path="/api/v1/n8n/workflows/:id" description="Workflow löschen" responseExample={{ success: true, data: { deleted: true } }} />
