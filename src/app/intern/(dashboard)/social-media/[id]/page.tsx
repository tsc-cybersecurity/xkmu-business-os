            ...
            <DialogContent>
              ...
              <div className="space-y-4">
                ...
                <Button onClick={handleImprove} disabled={improving} className="w-full">
                  {improving ? <Loader2 className="h-4 w-4 mr-2 animate-spin" /> : <Brain className="h-4 w-4 mr-2" />}
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Select value={post.platform} onValueChange={(v) => setPost(p => p ? { ...p, platform: v } : p)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
