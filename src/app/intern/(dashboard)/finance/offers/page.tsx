        ...
        <CardContent>
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <h3 className="mt-4 text-lg font-semibold">Keine Angebote</h3>
            ...
            <>
                ...
                <TableBody>
                  {documents.map((doc) => (
                    <TableRow key={doc.id}>
                      <TableCell>
                        <Link
                          href={`/intern/finance/offers/${doc.id}`}
                      ...
                      <TableCell>
                        <DocumentStatusBadge status={doc.status || 'draft'} type="offer" />
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              ...
              {meta && meta.totalPages > 1 && (
                <div className="flex items-center justify-between pt-4">
                  <p className="text-sm text-muted-foreground">{meta.total} Angebote gesamt</p>
