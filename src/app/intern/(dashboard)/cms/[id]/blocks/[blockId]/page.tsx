      ...
      <div className="space-y-3">
        ...
        {columns.map((col, i) => (
          <div key={i} className="flex gap-2 items-center">
            ...
            <Button variant="ghost" size="icon" className="h-8 w-8 shrink-0" onClick={() => removeColumn(i)}>
              <Trash2 className="h-3.5 w-3.5 text-destructive" />
            </Button>
          </div>
        ))}
        ...
        {rows.map((row, ri) => (
          <div key={ri} className="rounded-lg border p-3 space-y-2">
            <div className="flex gap-2 items-center">
              ...
              <Button variant="ghost" size="icon" className="h-8 w-8 shrink-0" onClick={() => removeRow(ri)}>
                <Trash2 className="h-3.5 w-3.5 text-destructive" />
              </Button>
            </div>
            <div className="grid grid-cols-2 gap-2">
